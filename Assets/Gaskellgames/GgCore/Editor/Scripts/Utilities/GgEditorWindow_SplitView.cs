...
namespace Gaskellgames.EditorOnly
{
    ...
    public abstract class GgEditorWindow_SplitView : GgEditorWindow
    {
        ...
        protected int pageYMin => (int)(shadowBuffer + standardSpacing + (GaskellgamesSettings_SO.Instance && GaskellgamesSettings_SO.Instance.ShowEditorWindowBanner ? bannerHeight : 0));
        
        #endregion

        //----------------------------------------------------------------------------------------------------
        
        #region Virtual Functions [Implement in child]
