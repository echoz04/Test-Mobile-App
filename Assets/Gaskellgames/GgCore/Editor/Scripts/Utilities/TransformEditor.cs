    ...
    public class TransformEditor : Editor
    {
        ...
        private void OnInspectorGUI_ResetButtons()
        {
            ...
            if (GUILayout.Button(buttonContent, EditorStyles.iconButton, GUILayout.Width(20), GUILayout.Height(20)))
            {
                ...
                {
                    AssignTransformEditor();
                    GgLogs.Log(this, LogType.Log, "Local position reset for {0}", names);
                }
            }
            GUILayout.Space(1);
            ...
            if (GUILayout.Button(buttonContent, EditorStyles.iconButton, GUILayout.Width(20), GUILayout.Height(20)))
            {
                ...
                {
                    AssignTransformEditor();
                    GgLogs.Log(this, LogType.Log, "Local rotation reset for {0}", names);
                }
            }
            GUILayout.Space(1);
            ...
            if (GUILayout.Button(buttonContent, EditorStyles.iconButton, GUILayout.Width(20), GUILayout.Height(20)))
            {
                ...
                {
                    AssignTransformEditor();
                    GgLogs.Log(this, LogType.Log, "Local scale reset for {0}", names);
                }
            }
            GUILayout.EndVertical();
        ...
        private void OnInspectorGUI_AlignTools()
        {
            ...
            {
	            AlignMin(axis);
	            GgLogs.Log(this, LogType.Log, "Selected targets aligned to their min point in the {0} axis.", axis);
            }
            ...
            {
	            AlignMid(axis);
	            GgLogs.Log(this, LogType.Log, "Selected targets aligned to their mid point in the {0} axis.", axis);
            }
            ...
            {
	            AlignMax(axis);
	            GgLogs.Log(this, LogType.Log, "Selected targets aligned to their max point in the {0} axis.", axis);
            }
            if (GUILayout.Button(GgGUI.IconContent("Icon_AlignDis", "Distribute all selected targets evenly on the selected Axis."), EditorStyles.miniButtonRight, GUILayout.Width(25), GUILayout.Height(20)))
            {
	            ...
	            GgLogs.Log(this, LogType.Log, "Selected targets distributed evenly in the {0} axis.", axis);
            }
            GUILayout.FlexibleSpace();
