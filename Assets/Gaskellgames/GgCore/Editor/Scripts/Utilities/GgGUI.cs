...
namespace Gaskellgames.EditorOnly
{
    ...
    public static class GgGUI
    {
        ...
        private static SerializedDictionary<string, Texture> icons;
        ...
        private static void Initialisation()
        {
            ...
            icons = new SerializedDictionary<string, Texture>(dictionary);
        ...
        public static bool TryAddCustomIcon(string name, Texture icon)
        {
            ...
            icons ??= new SerializedDictionary<string, Texture>();
